...
RELOJ:	
	...
	CP		R6, R13
	BRNE	SEGUIR1
	SBI		PORTD, 7;Alarma encendida
	RJMP	SEGUIR2 
SEGUIR1:
	CBI		PORTD, 7 ;Alarma apagada
SEGUIR2:
	LDI		R22, 0X00
	OUT		PORTB, R22
...
CONFECHA:
	...
	ADD		R19, R0
	;*-*
	CPI		R17, 0XFF ;Underflow meses
	BREQ	SEPTIEMBRE
	CPI		R19, 0X0D ;LLego año nuevo
	BREQ	ENERO
	CPI		R19, 0X00 ;Underflow meses, año anterior
	BREQ	DICIEMBREC
	CPI		R19, 0X0A ;Overflow llega a octubre
	BREQ	OCTUBRE

	LDI		R16, 0X0A; overflor dias
	CP		R14, R16
	BREQ	PONERA101

	LDI		R16, 0XFF ;underflow dias
	CP		R14, R16
	BREQ	VERMES

	LDI		R16, 0X09 ;Se llega solo a 28
	CP		R14, R16
	BREQ	ESFEBRERO
	
	LDI		R16, 0X00 ;underflow dias de 01 a 30 o 31 o28
	CP		R14, R16
	BREQ	VERMES1

	LDI		R16, 0X03 ;Estamos en 30
	CP		R15, R16
	BRNE	COMPROBAR31

	LDI		R16, 0X01 ; es mes de 30 dias
	CP		R14, R16
	BREQ	MESDE30DIAS
	LDI		R16, 0X02 ;es mes de 31 dias
	CP		R14, R16
	BREQ	ABRILREINICIO
	RJMP	COMPROBAR3
VERMES1:
